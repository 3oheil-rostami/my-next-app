...
import Show from './ShowTablighta'// import logo from '../public/images/logo.png'
  ...
  return (
    <div>
      ...
      <header style={{ textAlign: 'center', padding: '2rem' }}>
        ...
        <Image priority src={'/images/ali.jpg'} alt='user-image' height={100} width={100} style={{ borderRadius: '50% ' }} />
